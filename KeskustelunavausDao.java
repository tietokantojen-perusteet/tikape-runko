...
public class KeskustelunavausDao implements Dao<Keskustelunavaus, Integer> {
    ...
    public Keskustelunavaus findOne(Integer key) throws SQLException {
        ...
        PreparedStatement stmt = connection.prepareStatement("SELECT * FROM Keskustelunavaus WHERE avaus_id = ?");
    ...
    public void delete(Integer key) throws SQLException {
        Connection connection = database.getConnection();
        PreparedStatement stmt = connection.prepareStatement("DELETE * FROM Keskustelunavaus WHERE avaus_id = " + key);
        stmt.setObject(1, key);
